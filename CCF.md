For the Depository Trust and Clearing Corporation ([[DTCC]]), CCF and [[CCFII]] are legacy data transmission protocols that enable DTCC [[Participant]]s to send and receive files from DTCC's automated systems
