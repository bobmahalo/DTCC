For the Depository Trust and Clearing Corporation ([[DTCC]]), CCF and [[CCF-II are legacy data transmission protocols that enable DTCC participants to send and receive files from DTCC's automated systems
